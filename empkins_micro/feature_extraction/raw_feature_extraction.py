...
class RawFeatureExtraction:
    ...
    def write_file(self, base_path: path_t, subject_id: str, condition: str):
        ...
        tarfile_path_new = build_opendbm_tarfile_path(
            base_path=base_path, subject_id=subject_id, condition=condition, new=True
        )
        ...
        eyeblink_path = build_opendbm_raw_data_path(
            subject_id=self._subject_id, condition=self._condition, group="movement", subgroup="eyeblink_binarized"
        )[0]
